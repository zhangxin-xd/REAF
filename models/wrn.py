...
class WRNCifarBlock(nn.Module):
    ...
    def __init__(self, input_channels, block_channels, stride, projection_shortcut, use_dropout, builder:ConvCreater):
...
class WRNCifarNet(nn.Module):
    ...
    def __init__(self, block_counts, num_classes, builder:ConvCreater, use_dropout):
