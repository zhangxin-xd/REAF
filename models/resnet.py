...
class BasicBlock(nn.Module):
    ...
    def __init__(self, builder:ConvCreater, in_planes, planes, stride=1):
...
class ResNet(nn.Module):
    def __init__(self, builder:ConvCreater, block, num_blocks, num_classes=10, width_multiplier=None):
