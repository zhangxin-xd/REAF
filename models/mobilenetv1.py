...
class MobileV1Block(nn.Module):
    ...
    def __init__(self, builder:ConvCreater, in_planes, out_planes, stride=1):
...
class MobileV1CifarNet(nn.Module):
    ...
    def __init__(self, builder:ConvCreater, num_classes):
...
class MobileV1ImagenetNet(nn.Module):
    ...
    def __init__(self, builder:ConvCreater, num_classes, deps=None):
